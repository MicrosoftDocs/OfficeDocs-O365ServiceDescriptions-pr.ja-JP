...
> [!NOTE]
>  タスクのサポートが必要な場合、または問題のトラブルシューティングを行う場合、以下の記事が役立ちます。  <br/> •[電子メール](https://support.office.com/en-us/article/Email-94275804-7147-4332-9ccd-5d421760a9ed?ui=en-US&amp;rs=en-US&amp;ad=US)(電子メールの作成と送信に役立つ)  <br/> • [Office 365 for business の電子メール-管理者向けヘルプ](https://go.microsoft.com/fwlink/?linkid=529722) <br/>   • [Microsoft Support and Recovery Assistant for office 365 を使用して Outlook および office 365 の問題を修正し](https://diagnostics.office.com/)ます。 <br/>  • [Office 365 で配信不能レポート (メール) 365](https://go.microsoft.com/fwlink/?linkid=526653) <br/> • [Exchange Online ヘルプ](https://go.microsoft.com/fwlink/?linkid=825607) <br/>
  
Microsoft Exchange Online の制限は、次のカテゴリのいずれかに適合します。
...
- [ジャーナル、トランスポート、受信トレイのルールの制限](#journal-transport-and-inbox-rule-limits)
...
> [!IMPORTANT]
>  • Microsoft Office 365 組織に適用される制限は、その組織がサービスに登録されている期間によって異なる場合があります。<br/> • Microsoft データセンターで制限が変更された場合は、既存のすべてのお客様に変更を適用するのに時間がかかることがあります。<br/> •これらの制限の大部分を変更することはできませんが、ユーザーがそれらを認識する必要があります。<br/> •これらの制限は、内部および外部の両方の受信者に適用されます。<br/> •既定では、exchange online Protection (EOP) は exchange online メールボックスを保護します。exchange online の EOP 機能に適用される制限については、「 [exchange online Protection の制限](../exchange-online-protection-service-description/exchange-online-protection-limits.md)」を参照してください。<br/> • office 365 グループの制限の詳細については、「 [office 365 のグループについて](https://go.microsoft.com/fwlink/?linkid=846714)」の「my groups? を管理する方法」を参照してください。 
...
> [!NOTE]
> <sup>1</sup>各ユーザーは最初にアーカイブメールボックスで 100 GB の記憶域を受信します。自動拡張アーカイブが有効になっている場合は、100 GB の記憶域容量に達すると、追加の記憶域が自動的に追加されます。詳細については、「 [Office 365 での無制限アーカイブの概要](https://go.microsoft.com/fwlink/?linkid=844060)」を参照してください。可用性の詳細については、「 [Office 365 のロードマップ](http://go.microsoft.com/fwlink/?LinkId=509914)」を参照してください。<br/>  <sup>2</sup>共有メールボックスにアクセスするには、ユーザーが Exchange Online ライセンスを持っている必要があります。共有メールボックスには、別のライセンスは必要ありません。ただし、ライセンスがない場合、共有メールボックスは 50 GB に制限されます。メールボックスのサイズを大きくするには、E3 または E5 ライセンスを割り当てる必要があります。これにより、メールボックスは 100 GB に増加します。アーカイブメールボックスを有効にするか、共有メールボックスに訴訟ホールドを設定する場合は、exchange online プラン2ライセンスまたは exchange online プラン1の exchange online アーカイブライセンスが必要です。共有メールボックスのアーカイブメールボックスおよび自動拡張アーカイブを有効にした場合、アーカイブメールボックスの 100 GB の記憶域容量に達すると、追加の記憶域が自動的に追加されます。<br/>  <sup>3</sup>リソースメールボックスにライセンスは必要ありません。ただし、ライセンスがない場合、共有メールボックスは 50 GB に制限されます。メールボックスのサイズを大きくするには、E3 または E5 ライセンスを割り当てる必要があります。これにより、メールボックスは 100 GB に増加します。<br/>  <sup>4</sup> Exchange Online キオスクには、アーカイブメールボックスは含まれていません。ただし、Exchange Online アーカイブを使用してアドオンとして購入することができます。詳細については、「 [Exchange Online アーカイブサービスの説明](../exchange-online-archiving-service-description/exchange-online-archiving-service-description.md)」を参照してください。<br/>  <sup>5</sup>サイトメールボックスは、SharePoint Online で作成および管理されます。詳細については、「 [Office 365 でサイトメールボックスを使用するための準備](http://go.microsoft.com/fwlink/p/?LinkId=299131)」を参照してください。<br/>  <sup>6</sup>パブリックフォルダーのメールボックス数は1000に制限されており、すべてのパブリックフォルダーメールボックスの最大合計サイズは 50 TB です。メールボックスを提供する階層は、100のパブリックフォルダーメールボックスに制限されます。<br/>  <sup>7</sup>アーカイブメールボックスは、ライセンスが適用された単一のユーザーまたはエンティティ (共有メールボックスなど) のメールをアーカイブする場合にのみ使用できます。複数のユーザーまたはエンティティからのメールを格納する手段としてアーカイブメールボックスを使用することは禁止されています。たとえば、it 管理者は、アーカイブの明示的な目的のために、共有メールボックスを作成して、ユーザーがそれを (Cc または Bcc フィールドまたはトランスポートルールを使用して) コピーすることはできません。複数のユーザーが使用する共有メールボックスには、実際には個々のユーザーの電子メールが格納されていないことに注意してください。複数のユーザーがアクセスでき、共有メールボックスとしてメールを送信します。そのため、共有メールボックスに保存されるのは、共有メールボックス*として*送受信されるメールだけです。<br/>  <sup>8</sup> Exchange Online にアイテム保持ポリシーを作成済みの場合、ユーザーのプライマリメールボックスが 10 MB より大きい場合にのみ、メッセージはユーザーのアーカイブメールボックスに自動的に移動されます。アイテム保持ポリシーは、10 MB より小さいメールボックスに対しては自動的に実行されません。<br/>  <sup>9</sup>共有およびリソースメールボックスにライセンスは必要ありません。ただし、ライセンスがない場合、共有メールボックスは 50 GB に制限されます。メールボックスのサイズを大きくするには、E3 または E5 ライセンスを割り当てる必要があります。これにより、メールボックスは 100 GB に増加します。 
...
|:-----|:-----|:-----|:-----|:-----|
|**機能** <br/> |**Exchange Server 2013** <br/> |**Exchange Online プラン 1** <br/> |**Exchange Online プラン 2** <br/> |**Exchange Online Kiosk** <br/> |
|ユーザー メールボックス  <br/> |2 GB<sup>1</sup> <br/> |50 GB  <br/> |100 GB  <br/> |2 GB  <br/> |
|アーカイブ メールボックス<sup>8、9</sup> <br/> |100 GB<sup>1</sup> <br/> |50 GB  <br/> |無制限<sup>2</sup> <br/> |使用不可<sup>5</sup> <br/> |
|共有メールボックス  <br/> |2 GB<sup>1</sup> <br/> |50 GB<sup>3</sup> <br/> |50 GB<sup>3、10</sup> <br/> |50 GB<sup>3</sup> <br/> |
|リソース メールボックス  <br/> |2 GB<sup>1</sup> <br/> |50 GB<sup>4</sup> <br/> |50 GB<sup>4、10</sup> <br/> |50 GB<sup>4</sup> <br/> |
|パブリック フォルダー メールボックス  <br/> |2 GB<sup>6</sup> <br/> |50 GB<sup>7</sup> <br/> |100 GB<sup>7</sup> <br/> |使用不可  <br/> |
|グループ メールボックス  <br/> |50 GB  <br/> |50 GB  <br/> |50 GB  <br/> |50 GB  <br/> |
   
> [!NOTE]
> <sup>1</sup>これは、Exchange Server 2013 組織の既定のメールボックスサイズです。管理者は、組織のこの値を変更できます。オンプレミスのメールボックスの最大記憶域の制限はありません。<br/>  <sup>2</sup>各ユーザーは最初にアーカイブメールボックスで 100 GB の記憶域を受信します。自動拡張アーカイブが有効になっている場合は、100 GB の記憶域容量に達すると、追加の記憶域が自動的に追加されます。詳細については、「 [Office 365 での無制限アーカイブの概要](https://go.microsoft.com/fwlink/?linkid=844060)」を参照してください。自動拡張アーカイブの可用性の詳細については、「 [Office 365 ロードマップ](http://go.microsoft.com/fwlink/?LinkId=509914)」を参照してください。<br/> <sup>3</sup>共有メールボックスにアクセスするには、ユーザーが Exchange Online ライセンスを持っている必要があります。共有メールボックスには、別のライセンスは必要ありません。ただし、ライセンスがない場合、共有メールボックスは 50 GB に制限されます。メールボックスのサイズを増やすには、Exchange Online プラン2ライセンスが割り当てられている必要があります。これにより、メールボックスは 100 GB に増加します。アーカイブメールボックスを有効にするか、共有メールボックスに訴訟ホールドを設定する場合は、exchange online プラン2ライセンスまたは exchange online プラン1の exchange online アーカイブライセンスが必要です。共有メールボックスのアーカイブメールボックスおよび自動拡張アーカイブを有効にした場合、アーカイブメールボックスの 100 GB の記憶域容量に達すると、追加の記憶域が自動的に追加されます。<br/> <sup>4</sup>リソースメールボックスにライセンスは必要ありません。ただし、ライセンスがない場合、共有メールボックスは 50 GB に制限されます。メールボックスのサイズを増やすには、Exchange Online プラン2ライセンスが割り当てられている必要があります。これにより、メールボックスは 100 GB に増加します。<br/>  <sup>5</sup>アーカイブメールボックスは Exchange Online Kiosk には含まれていません。ただし、Exchange Online アーカイブを使用してアドオンとして購入することができます。詳細については、「 [Exchange Online アーカイブサービスの説明](../exchange-online-archiving-service-description/exchange-online-archiving-service-description.md)」を参照してください。<br/>  <sup>6</sup>これは、Microsoft Exchange Server 2013 組織の既定のメールボックスサイズです。管理者は、組織のこの値を変更できます。Exchange Server 2013 では、パブリックフォルダーのメールボックス数は100に制限されており、すべてのパブリックフォルダーメールボックスの合計サイズは最大で 50 TB です。<br/>  <sup>7</sup> Exchange Online では、パブリックフォルダーのメールボックス数は1000に制限されており、すべてのパブリックフォルダーメールボックスの合計サイズは最大で 50 TB です。<br/>  <sup>8</sup>アーカイブメールボックスは、ライセンスが適用された単一のユーザーまたはエンティティのメールをアーカイブする場合にのみ使用できます。複数のユーザーまたはエンティティからのメールを格納する手段としてアーカイブメールボックスを使用することは禁止されています。たとえば、IT 管理者は共有メールボックスを作成して、ユーザーが (Cc または Bcc フィールドを通じて、またはトランスポートルールを介して) 共有メールボックスをアーカイブの明示的な目的でコピーすることはできません。<br/>  <sup>9</sup> Exchange Online にアイテム保持ポリシーを作成済みの場合、ユーザーのプライマリメールボックスのサイズが 10 MB を超えている場合にのみ、メッセージはユーザーのアーカイブメールボックスに自動的に移動されます。アイテム保持ポリシーは、10 MB より小さいメールボックスに対しては自動的に実行されません。<br/>  <sup>10</sup>共有およびリソースメールボックスにライセンスを割り当てる必要はありません。ただし、ライセンスがない場合、これらのメールボックスは 50 GB に制限されます。メールボックスのサイズを大きくするには、Exchange Online プラン2ライセンスが割り当てられている必要があります。これにより、メールボックスは 100 GB に増加します。 
  
> [!NOTE]
> 共有メールボックスは、直接ログオンを目的としたものではありません。共有メールボックス自体のユーザーアカウントは、**無効**(または "切断") 状態のままになります。 
...
|送信禁止  <br/> |2 GB<sup>1</sup> <br/> |49.5 GB  <br/> |99 GB  <br/> |1.98 GB  <br/> |
...
|:-----|:-----|:-----|:-----|:-----|:-----|:-----|
|**機能** <br/> |**Office 365 Business Essentials** <br/> |**Office 365 Business Premium** <br/> |**Office 365 Enterprise E1** <br/> |**Office 365 Enterprise E3** <br/> |**Office 365 Enterprise E5** <br/> |**Office 365 Enterprise F1** <br/> |
|メールボックス フォルダーごとの最大メッセージ数  <br/> |100 万個  <br/> |100 万個  <br/> |100 万個  <br/> |100 万個  <br/> |100 万個  <br/> |100 万個  <br/> |
...
|アーカイブ メールボックスの回復可能なアイテム フォルダーの記憶域のクォータ (保留である)  <br/> |100 GB<sup>1</sup> <br/> |100 GB<sup>1</sup> <br/> |100 GB<sup>1</sup> <br/> |無制限<sup>2</sup> <br/> |無制限<sup>2</sup> <br/> |100 GB<sup>1</sup> <br/> |
...
> [!NOTE]
> <sup>1</sup>これは、アーカイブメールボックス全体のクォータではなく、回復可能なアイテムフォルダーの記憶域のクォータです。exchange online プラン2ライセンスを持つユーザー、または exchange online プラン1と exchange online アーカイブライセンスの両方を持つユーザーに対して、アーカイブメールボックスの記憶域クォータは無制限です。回復可能なアイテムのクォータを増やす方法については、「[ホールド状態のメールボックスの回復可能なアイテムのクォータを増やす](http://technet.microsoft.com/library/a8bdcbdd-9298-462f-b889-df26037a990c.aspx)」を参照してください。<br/> <sup>2</sup>アーカイブメールボックスの回復可能なアイテムフォルダーの最初の記憶域のクォータは 100 GB です。自動拡張アーカイブが有効になっている場合は、回復可能なアイテムフォルダーの記憶域容量に達すると、追加の記憶域が自動的に追加されます。詳細については、「 [Office 365 での無制限アーカイブの概要](https://go.microsoft.com/fwlink/?linkid=844060)」を参照してください。自動拡張アーカイブの可用性の詳細については、「 [Office 365 ロードマップ](http://go.microsoft.com/fwlink/?LinkId=509914)」を参照してください。 
...
|メールボックス フォルダーごとの警告を出すメッセージ数  <br/> |無制限  <br/> |900,000  <br/> |900,000  <br/> |900,000  <br/> |
|復元可能アイテム フォルダー内のフォルダーごとの最大メッセージ数  <br/> |無制限  <br/> |300 万  <br/> |300 万  <br/> |300 万  <br/> |
...
|メールボックス フォルダーごとのサブフォルダー数の最大値  <br/> |無制限  <br/> |1000  <br/> |1000  <br/> |1000  <br/> |
...
|パブリック フォルダーごとのサブフォルダーの最大数  <br/> |N/A  <br/> |1,000  <br/> |1,000  <br/> |使用不可  <br/> |
|パブリック フォルダーごとの警告を出すサブフォルダー数  <br/> |該当なし  <br/> |900  <br/> |900  <br/> |使用不可  <br/> |
   
> [!NOTE]
> <sup>1</sup> Microsoft では、メールボックスフォルダーごとに100万を超えるメッセージは推奨していません。><br/> <sup>2</sup>これは、アーカイブメールボックス全体のクォータではなく、回復可能なアイテムフォルダーの記憶域のクォータです。exchange online プラン2ライセンスを持つユーザー、または exchange online プラン1と exchange online アーカイブライセンスの両方を持つユーザーに対して、アーカイブメールボックスの記憶域クォータは無制限です。回復可能なアイテムのクォータを増やす方法については、「[ホールド状態のメールボックスの回復可能なアイテムのクォータを増やす](http://technet.microsoft.com/library/a8bdcbdd-9298-462f-b889-df26037a990c.aspx)」を参照してください。<br/> <sup>3</sup>アーカイブメールボックスの回復可能なアイテムフォルダーの初期記憶域のクォータは 100 GB です。自動拡張アーカイブが有効になっている場合は、回復可能なアイテムフォルダーの記憶域容量に達すると、追加の記憶域が自動的に追加されます。詳細については、「 [Office 365 での無制限アーカイブの概要](https://go.microsoft.com/fwlink/?linkid=844060)」を参照してください。自動拡張アーカイブの可用性の詳細については、「 [Office 365 ロードマップ](http://go.microsoft.com/fwlink/?LinkId=509914)」を参照してください。 
...
> [!NOTE]
> <sup>1</sup> Office 365 メールボックスの既定の最大メッセージサイズは 25 MB です。Office 365 管理者は、1 mb と 150 MB の間でユーザー設定の制限を指定できます。ただし、送受信できるメッセージのサイズは、メールクライアントまたはソリューションがサポートしているものによっても異なります。組織に対して許可される最大メッセージサイズのカスタマイズの詳細については、「 [Office 365 が大きな電子メールメッセージをサポートするようになりました](https://blogs.office.com/2015/04/15/office-365-now-supports-larger-email-messages-up-to-150-mb/)」を参照してください。<br/> <sup>2</sup> Office 365 のユーザー間で最大 150 MB のメッセージを送受信できます (メッセージが Office 365 データセンターの外部に出ない場合)。Office 365 データセンターの外部にルーティングされるメッセージは、変換エンコードにより 33% 大きいサイズになるため、最大メッセージ サイズは 112 MB になります。<br/> <sup>3</sup> OWA アカウントでは、メッセージのエンコードが 33% になる可能性があり、送信できるメッセージのサイズが、構成された設定よりも 25% 少なくなるように制限されている可能性があります。たとえば、100 mb の最大メッセージサイズの設定をカスタマイズした場合は、75 MB 以下のメッセージを送信できます。<br/> <sup>4</sup> Exchange Online に移動するメッセージのサイズは Exchange Online によって計算されます。Exchange Server 2013 より前のバージョンの Exchange では、アイテムのサイズが小さく報告されます。この制限は、サポート対象の Exchange メールボックス レプリケーション サービスを使用する、移動ベースの移行に適用されます。その他の移行方法 (一括、段階的な IMAP、PST) およびその他のサード パーティ製ツールは、一般的なメッセージ サイズの制限を受けます。<br/> <sup>5</sup> 新しい機能を備えた OME については、「 [Azure Information Protection をベースにした新しい Office 365 Message Encryption 機能を構築する](https://support.office.com/en-us/article/Set-up-new-Office-365-Message-Encryption-capabilities-built-on-top-of-Azure-Information-Protection-7ff0c040-b25c-4378-9904-b1b50210d00e?ui=en-US&amp;rs=en-US&amp;ad=US)」を参照してください。<br/> <sup>6</sup> 1 つで 35 MB を超えるファイルは添付できません。また、ファイルの合計が 35 MB を超える場合も添付することはできません。たとえば、34 MB の 1 つのファイルを添付する場合、その他に添付できるファイルは 1 MB までです。 
...
|添付ファイルの制限  <br/> |1024添付ファイル<sup>4</sup> <br/> |250 個の添付ファイル  <br/> |250 個の添付ファイル  <br/> |250 個の添付ファイル  <br/> |
...
> [!NOTE]
> <sup>1</sup> Office 365 管理者は、1 mb から 150 MB の間でユーザー設定の制限を指定できます。ただし、送受信できるメッセージのサイズは、メールクライアントまたはソリューションがサポートしているものによっても異なります。組織に対して許可される最大メッセージサイズのカスタマイズの詳細については、「 [Office 365 が大きな電子メールメッセージをサポートするようになりました](https://blogs.office.com/2015/04/15/office-365-now-supports-larger-email-messages-up-to-150-mb/)」を参照してください。<br/> <sup>2</sup> Office 365 のユーザー間で最大 150 MB のメッセージを送受信できます (メッセージが Office 365 データセンターの外部に出ない場合)。Office 365 データセンターの外部にルーティングされるメッセージは、変換エンコードにより 33% 大きいサイズになるため、最大メッセージ サイズは 112 MB になります。<br/> <sup>3</sup> OWA アカウントでは、メッセージのエンコードが 33% になる可能性があり、送信できるメッセージのサイズが、構成された設定よりも 25% 少なくなるように制限されている可能性があります。たとえば、100 mb の最大メッセージサイズの設定をカスタマイズした場合は、75 MB 以下のメッセージを送信できます。<br/> <sup>4</sup>これは、Exchange Server 2013 組織の既定の制限です。管理者は、組織のこの値を変更できます。<br/> <sup>5</sup> exchange online に移動するメッセージのサイズは、exchange online によって計算されます。exchange Server 2013 より前のバージョンの exchange では、アイテムのサイズが小さくなることがあります。<br/> <sup>6</sup> 新しい機能を備えた OME については、「 [Azure Information Protection をベースにした新しい Office 365 Message Encryption 機能を構築する](https://support.office.com/en-us/article/Set-up-new-Office-365-Message-Encryption-capabilities-built-on-top-of-Azure-Information-Protection-7ff0c040-b25c-4378-9904-b1b50210d00e?ui=en-US&amp;rs=en-US&amp;ad=US)」を参照してください。 
...
|受信したメッセージ  <br/> |1時間あたり3600のメッセージ  <br/> |1時間あたり3600のメッセージ  <br/> |1時間あたり3600のメッセージ  <br/> |1時間あたり3600のメッセージ  <br/> |1 時間あたり 3600 のメッセージ  <br/> |1 時間あたり 3600 のメッセージ  <br/> |
...
|メッセージ数の制限  <br/> |1 分あたり 30 個のメッセージ  <br/> |1 分あたり 30 個のメッセージ  <br/> |1 分あたり 30 個のメッセージ  <br/> |1 分あたり 30 個のメッセージ  <br/> |1 分あたり 30 個のメッセージ  <br/> |1 分あたり 30 個のメッセージ  <br/> |
...
|受信者の制限  <br/> |500受信者<sup>1</sup> <br/> |500 の受信者  <br/> |500 の受信者  <br/> |500 の受信者  <br/> |
...
|削除済みアイテム フォルダーから削除されたアイテムの保存期限  <br/> |14日<sup>1</sup>日 <br/> |14日<sup>1</sup>日 <br/> |14日<sup>1</sup>日 <br/> |14日<sup>1</sup>日 <br/> |14日<sup>1</sup>日 <br/> |14日<sup>1</sup>日 <br/> |
|迷惑メール フォルダーの保存期限  <br/> |30 日間  <br/> |30 日  <br/> |30 日  <br/> |30 日  <br/> |30 日  <br/> |30 日  <br/> |
...
|削除済みアイテム フォルダーから削除されたアイテムの保存期限  <br/> |14日<sup>1</sup>日 <br/> |14日間<sup>2</sup> <br/> |14日間<sup>2</sup> <br/> |14日間<sup>2</sup> <br/> |
|迷惑メール フォルダーの保存期限  <br/> |2年間<sup>1</sup> <br/> |30 日  <br/> |30 日間  <br/> |30 日  <br/> |
   
> [!NOTE]
> <sup>1</sup> これは既定の制限です。管理者は、組織に適用されるこの値を変更できます。<br/> <sup>2</sup>これは、Exchange Online 組織の既定値です。管理者は、組織内のメールボックスでこの値を最大30日に変更できます。 
...
|すべてのトランスポート ルールによってメッセージに追加される最大受信者数  <br/> |無制限  <br/> |100 の受信者  <br/> |100 の受信者  <br/> |100 の受信者  <br/> |
|被転送者の制限  <br/> |無制限  <br/> |10 の受信者  <br/> |10 の受信者  <br/> |10 の受信者  <br/> |
...
|モデレートを待機しているメッセージの有効期限  <br/> |5日<sup>目</sup> <br/> |2 日  <br/> |2 日  <br/> |2 日  <br/> |
...
|Exchange ActiveSync デバイス削除の制限  <br/> |1280  <br/> |1280  <br/> |1280  <br/> |1280  <br/> |1280  <br/> |1280  <br/> |
...
|Exchange ActiveSync デバイス削除の制限  <br/> |1280  <br/> |1280  <br/> |1280  <br/> |1280  <br/> |
