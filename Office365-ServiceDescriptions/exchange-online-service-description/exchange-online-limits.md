...
|メッセージのリダイレクト回数|1 回のリダイレクト|1 回のリダイレクト|1 回のリダイレクト|1 回のリダイレクト|1 回のリダイレクト|1 回のリダイレクト|
|受信トレイルール|256 kb<sup>1</sup>|256 kb<sup>1</sup>|256 kb<sup>1</sup>|256 kb<sup>1</sup>|256 kb<sup>1</sup>|256 kb<sup>1</sup>|

> [!NOTE]
> <sup>1</sup>メールボックスが Exchange Online に移行された場合、受信トレイルールの制限は、既定の exo 値より小さい値に設定される場合があります。 その場合は、次のようにして値を増やすことができます。 
