...
[Exchange Online で配信不可レポートを電子メールで送信する](/Exchange/mail-flow-best-practices/non-delivery-reports-in-exchange-online/non-delivery-reports-in-exchange-online)<br/> 
[Exchange Online ヘルプ](/exchange/exchange-online)
...
Exchange 管理センターの新機能については、「Exchange 管理センターの新機能」 [を参照してください](/exchange/whats-new)。
...
Microsoft 365 F1 には、Exchange メールボックスに対する権限は含されません。 完全な Teams エクスペリエンスを有効にするには、M365 F1 ライセンスに Exchange Online K1 サービス プランが有効になっている場合があります。 Exchange Online K1 サービス プランはユーザー向けのメールボックスをプロビジョニングしますが、M365 F1 ユーザーにはメールボックスを使用する権利が与えられません。 これらの手順を使用して Outlook on [](/exchange/recipients-in-exchange-online/manage-user-mailboxes/enable-or-disable-outlook-web-app) the web を無効にし、他の方法で Exchange メールボックスにアクセスしなかってください。
...
<sup>6 Exchange Server</sup> 2013 には、2010 年と同じ組み込みのスパム対策機能Exchange Serverがあります。 オンプレミスの製品に対する Exchange ホスト型スパム フィルター処理の利点については、「Exchange Online Protection Over [Exchange Server 2013](/exchange/benefits-of-anti-spam-features-in-exchange-online-protection-over-exchange-server-2013-exchange-2013-help)のスパム対策機能の利点」を参照してください。 <br/>
...
<sup>17 接続</sup> 済みアカウントは POP IMAP アカウントでサポートされますが、このアカウントでは Outlook.com &amp; (Hotmail)。 <br/>
...
<sup>2</sup> オンプレミスの製品に対する Exchange ホスト型スパム フィルターの利点については、「Exchange Online Protection Over [Exchange Server 2013](/exchange/benefits-of-anti-spam-features-in-exchange-online-protection-over-exchange-server-2013-exchange-2013-help)のスパム対策機能の利点」を参照してください。 <br/>
...
<sup>17</sup> Exchange Online プラン 1 には、メールボックス [とアーカイブのサイズ制限があります](./exchange-online-limits.md)。 Exchange Online Archiving Exchange Online アドオンの場合、無制限のクラウドベースのアーカイブと [インプレイス保持が追加されます](../exchange-online-archiving-service-description/compliance-and-security-features.md#in-place-hold-and-litigation-hold)。 <br/>
<sup>18</sup> Exchange Online Kioskは、OWA 経由でのみアクセスまたは共有できます。 <br/>
<sup>19</sup> 接続済みアカウントは POP IMAP アカウントでサポートされますが、このアカウントでは無効 Outlook.com &amp; (Hotmail)。 <br/>
