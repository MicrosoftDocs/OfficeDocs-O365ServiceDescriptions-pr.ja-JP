...
Outlook Web App は、Exchange Online と一緒に使用される Outlook 電子メール プログラムの Web ベース バージョンです。 ユーザーは、自宅、オフィス、または外出先でインターネットに接続されている場合でも、Outlook Web App 経由で電子メールにアクセスすることができます。
