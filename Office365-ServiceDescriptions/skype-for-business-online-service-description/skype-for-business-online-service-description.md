...
|自分の写真: URL 写真の表示  <br/> |はい  <br/> |不要  <br/> |いいえ  <br/> |
...
|AOL および Yahoo! フェデレーション  <br/> |はい  <br/> |不要  <br/> |いいえ  <br/> |
...
|Skype for Business Online スタンドアロン プラン 2  <br/> | Skype 会議メディア  <br/>  開催者、プロデューサー、イベントチームメンバー、および認証済み出席者の場合、Office 365 ライセンスが必要です。  <br/>  匿名の出席者の場合は、Office 365 ライセンスは必要ではありません。  <br/>  プラン 2 を含む Skype for Business Online スタンドアロン プラン 2 または任意の Office 365 スイートを使用すると、次のアドオンが使用できます。  <br/> -電話会議 (限られた国で利用可能) <br/> -電話システム <br/>**メモ**通話プランなしで単独で購入した場合、電話システムはハイブリッド音声機能のみを有効にします。 ハイブリッド音声には、既存の PSTN サービス プロバイダーを使用して PSTN 通話を可能にするオンプレミスのカスタマー ハイブリッド音声展開が必要です。 以下の電話システム アドオンでは、PSTN サービス プロバイダーとして Microsoft を使用することで、着信と発信の PSTN 通話を有効にすることができます。<br/>-国内通話プラン (限られた国で利用可能)<br/>-国際通話プラン (限られた国で利用可能)          |
