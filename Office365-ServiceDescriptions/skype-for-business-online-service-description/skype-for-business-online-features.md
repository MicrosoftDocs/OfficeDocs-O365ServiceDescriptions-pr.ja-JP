...
description: 管理者の場合は、「オンラインの設定」でオンライン機能Skype for Business詳細な手順Skype for Businessできます。
...
管理者の場合は、「オンラインの設定」でオンライン機能Skype for Business手順をSkype for Business[できます](https://support.office.com/article/40296968-e779-4259-980b-c2de1c044c6e)。
...
- Windows または Mac に対するユーザーの Skype for Business Online クライアントのオプションを確認するには、「[Skype for Business をインストールする](https://go.microsoft.com/fwlink/?linkid=847563)」を参照してください。
...
モバイル デバイス、PC、または Mac 用のクライアントをダウンロードするには、[すべてのデバイスでデバイスをダウンロード[Skype for Business] に移動します](https://go.microsoft.com/fwlink/?linkid=846929)。
  
Skype for Business では、上記のサイトに記載されている各会議室デバイスをサポートします。 詳細については、アカウント チームと一緒に作業するか、Microsoft サポートに [問い合わせください](https://support.office.com/article/32a17ca7-6fa0-4870-8a8d-e25ba4ccfd4b)。 電話番号を確認するには、ドロップダウン リストからロケールを選択します。
  
## <a name="instant-messaging-presence-and-contacts"></a>インスタント メッセージング、プレゼンス、および連絡先

Skype for Business を使って、ユーザーは次のことができます。
  
- 他のユーザーに空き時間情報を知らせる場合は、[利用可能]、[離れて]、[通知しない]、または [オフライン] など、プレゼンス状態 &mdash; &mdash; を表示します。 Skype for Businessプレゼンス情報はスイート全体に表示されます。
    
- インターネットなどのインターネット プロトコル (IP) ネットワーク、または組織の企業ネットワークを通して、リアルタイムでテキスト メッセージを送受信します。 インスタント メッセージングは、Skype 間通信とマルチパーティ通信の両方で利用可能です。 IM テキストはセキュリティ強化のために暗号化されます。
    
- 自分の Skype for Business 連絡先カードが他のユーザーにどのように表示されるかを構成する。
    
インスタント メッセージング、プレゼンス、連絡先の詳細については、「インスタント メッセージングの IM を送信する」を参照[Skype for Business。](https://support.office.com/article/b3aefb9b-dec8-4be8-a1ee-1eab12144d05)
...
オーディオに加えて、ユーザー Skype for Business高品質のビデオ セッションを介して接続することもできます。 1 対 1 のセッションとマルチパーティ (ユーザー 3 人以上) セッションの両方がサポートされています。 アクティブ スピーカー ビデオは、マルチパーティ セッションでのみ使用できます。 Skype for Business では、ユーザーは容易にオンラインのビデオ会議をスケジュールしたり、IM セッションをビデオ通話にシームレスにエスカレートしたりすることができます。
  
オンライン会議の詳細については、「Skype for Business IM およびオンライン会議Skype for Business[使用を開始する」を参照してください](https://support.office.com/article/cc05afa6-1894-4a82-9dd9-6222061f50fd)。
...
Microsoft トラフィック (信号トラフィックとメディア トラフィックの両方) は、トランスポート層セキュリティ (TLS) プロトコルを使用して暗号化されます。 誰かが通信を傍受しても暗号化されたテキストしか見ることができません。 たとえば、空港などの公衆 Wi-Fi ネットワークを使用中に Skype for Business Online の IM や通話、プレゼンテーションにアクセスした場合、ネットワーク スニファーによって通信が傍受されるおそれがあるため、ユーザーの通信は暗号化されます。
...
- ボイス メッセージングと電子メール メッセージングを、クライアントから使用できる単一のメッセージング インフラストラクチャSkype for Businessします。 Exchange UM と Skype for Business は連携して、通話応答、Outlook Voice Access、および自動応答サービスを提供します。
    
- Web Outlookを有効にして、IM、プレゼンス、予定表情報、および会議のスケジュールにExchange状態の更新Skype for Business提供します。
...
Microsoft は、すべての Skype for Business データ センターを直接制御し、システムの全体的なパフォーマンスを担当しますが、ユーザーの全体的なエクスペリエンスを提供するために組み合わせる要素の一部のみを制御できます。 組織自体は、データ センターへのネットワーク接続、顧客のワイド エリア ネットワーク (WAN)、および顧客のローカル エリア ネットワーク (LAN) を担当します。 さらに、ユーザー デバイスとその構成を管理します。また、ユーザーが機能にアクセスする必要がある限り、これらの機能を管理する機能を含むが、これらに限定されない任意の機能に対して、ユーザーごとに必要なライセンスを維持する責任があります。
...
オンライン管理者の最新Skype for Businessヘルプ トピックと方法に関する記事については、「Skype for Business - 管理者向けヘルプ」[を参照してください](https://support.office.com/article/4307bdbf-6097-458d-9a6a-048112695c59)。
...
Skype for Business公衆交換電話網 (PSTN) で見つかった通話機能が含まれます。 通話プランは[、電話システム](#phone-system)のアドオンであり、組織内のユーザーに電話番号を検索、取得、割り当て、Office 365 から直接、組織の内部および外部のユーザーに電話を発信および受信できます。 電話番号が割り当てられているユーザーは、VoIP 電話、PC、モバイル デバイスなどSkype for Businessデバイス間で音声通話を行えます。 また、ミュート/ミュート解除、保留/再開、通話転送、通話転送機能を使用して通話を制御し、必要に応じて緊急通話を行います。 
...
この電話システムを使用Skype for Business、組織の既存の電話回線、または受信通話と発信通話電話システムを使用できます。 Office 365 の 電話システム を使用すると、Skype for Business を使用して、インターネット にアクセスできるほぼどこからでも通話の配置、受信、転送、ミュート、ミュート解除などの基本的なタスクを実行できます。
  
この電話システムでは、既存の PBX システムを、Microsoft から直接提供され、Microsoft のクラウド生産性エクスペリエンスに緊密に統合された一連の機能に置き換えできます。 完全なイン ザ クラウド エクスペリエンスを選択することも、一部の機能をオンプレミスで維持しながら電話システムの利点を活用するハイブリッド展開を選択することもできます。
  
## <a name="skype-meeting-broadcast"></a>Skype 会議メディア

Skype会議ブロードキャストを使用すると、ユーザーはインターネット上で会議を作成およびブロードキャストして最大 10,000 人の出席者に送信できます。ユーザーは、事実上任意のデバイス上のブラウザーから出席できます。 会議Skypeを使用すると、内部の "役場" スタイルの会議や公開ウェビナーなどの大規模な仮想会議を開催できます。 会議を記録し、ユーザーの関与と満足度を評価するためにカスタマイズできます。 
