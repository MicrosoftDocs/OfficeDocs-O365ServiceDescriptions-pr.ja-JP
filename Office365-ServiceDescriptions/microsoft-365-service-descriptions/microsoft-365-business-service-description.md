...
<sup>9</sup> windows 7 および 8.1 Professional のライセンスを持つデバイスがある場合、Microsoft 365 Business Premium は Windows 10 Pro へのアップグレードを提供します。 Microsoft 365 Business Premium を使用すると、 [Windows Pro で有効になる Microsoft Defender のセキュリティ機能](https://go.microsoft.com/fwlink/p/?linkid=2089903)を取得できるだけでなく、web ベースの脅威に対するネットワーク保護や、ランサムウェア対策のためのホスト侵入防止ルールにもアクセスできるようになります。 Microsoft 365 Business Premium アカウントをセットアップする場合は、[アプリの保護] と [デバイス構成の設定] を選択します。 これらの設定は、Azure Active Directory に参加するときにデバイスに自動的に適用されるポリシーを決定します。</br>
