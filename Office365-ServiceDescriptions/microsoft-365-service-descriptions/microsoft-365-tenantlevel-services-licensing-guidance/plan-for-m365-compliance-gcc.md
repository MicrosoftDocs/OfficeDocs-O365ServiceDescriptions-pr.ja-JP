...
|                                         | プラットフォーム間 (web、Android、iOS、Windows、および Mac) Office アプリ (Word、Excel、PowerPoint、Outlook) の自動分類とラベル付け |  開発中              |
...
|                                         | 情報ガバナンス: Teams の保持ポリシー                            | Available |
...
|                                         | 通信コンプライアンス (監督ポリシーを含む): 顧客ポリシーの作成、3 つの事前構成済み  | ロール アウト |
|                                         | 通信コンプライアンス (監督ポリシーを含む): Teams、Exchange、および Teams メッセージの削除のサポート | ロール アウト |
|                                         | 通信コンプライアンス (監督ポリシーを含む): アクセス通知。通知テンプレート。通信ポリシー ダッシュボード | ロール アウト  |
|                                         | 通信コンプライアンス (監督ポリシーを含む): 高度な電子情報開示の調査をエスカレートする | ロール アウト |
|                                         | コミュニケーション コンプライアンス (監督ポリシーを含む): 成人向けコンテンツを検出する | ロール アウト |
|                                         | 通信コンプライアンス: 時間の間に繰り返し行動規範違反を検出する | ロール アウト |
|                                         | 通信コンプライアンス: より詳細なアクセス許可のサポート | ロール アウト |
|                                         | 通信コンプライアンス: プレムメールボックスを使用してユーザーの Teams チャット データを分析する | ロール アウト |
|                                         | コミュニケーション コンプライアンス: 利益相反テンプレート | エンジニアリング バックログについて |
|                                         | 通信コンプライアンス: 電子メールの署名または免責事項を無視する機能 | エンジニアリング バックログについて |
|                                         | コミュニケーション コンプライアンス: Insider リスク管理ハンドオフ | エンジニアリング バックログについて |
|                                         | 通信コンプライアンス: ポリシーの正常性チェックとポリシーを一時停止する機能 | エンジニアリング バックログについて |
|                                         | コミュニケーション コンプライアンス: 調査中に正常性コンテンツを翻訳する | エンジニアリング バックログについて |
|                                         | 通信コンプライアンス: バーンアウトと自殺の検出 | エンジニアリング バックログについて |
...
|                                         | コア電子情報開示: Microsoft コンプライアンス センターは、SharePoint および OneDrive for Business ごみ箱のアイテムの検索とエクスポートのサポートを拡張しました                                        | 開発中              |
|                                         | 高度な電子情報開示: 高度な処理                             | Available |
|                                         | 高度な電子情報開示: ダッシュボード                                 | Available |
|                                         | 高度な電子情報開示: 電子メール スレッド                   | Available |
|                                         | 高度な電子情報開示: エクスポート (ダウンロード、エクスポート、別のビュー セットへの追加)                                          | Available |
...
|                                         | 高度な電子情報開示: PST エクスポートのサポート                              | Available |
...
|                                         | 高度な電子情報開示: Microsoft コンプライアンス センターでは、SharePoint および OneDrive for Business ごみ箱内のアイテムを検索およびエクスポートするサポートが拡張されました                              | 開発中 |
...
|                                         | 高度な監査: セキュリティとコンプライアンス センター                               | Available |
