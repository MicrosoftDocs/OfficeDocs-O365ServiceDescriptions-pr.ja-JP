...
- **リストまたはライブラリごとの固有のセキュリティスコープ**-強制される制限は5万ですが、推奨される一般的な制限は5000です。 5000より上では、アクセス制御リスト (ACL) サイズは重要です。 適用範囲を5万の強制制限に合わせて追加することはできますが、特に注意が必要なシナリオがない限り、マイクロソフトはお勧めしません。 大きなリストの場合は、固有の権限ができるだけ少なくて済むように設計します。
