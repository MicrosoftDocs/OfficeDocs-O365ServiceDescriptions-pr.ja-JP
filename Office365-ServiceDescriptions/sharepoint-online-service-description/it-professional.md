...
SharePoint Online は、Web ベースのツールと保存、共有、およびデジタル情報を管理する組織を支援するテクノロジの集まりです。Microsoft SharePoint Server 2013 でホストされているこのサービスは、プロジェクトで作業して、データとドキュメントを格納する中央の場所で他のユーザーと情報の共有に最適です。次の SharePoint の機能で保護し、組織の SharePoint 環境を管理する IT プロフェッショナルをサポートします。 
...
## <a name="alternate-access-mapping-aam"></a>代替アクセス マッピング (AAM)
...
## <a name="host-header-site-collections"></a>ホスト ヘッダー サイト コレクション
...
## <a name="remote-blob-storage"></a>リモート BLOB ストレージ
...
## <a name="service-application-platform"></a>サービス アプリケーション プラットフォーム
...
## <a name="sharepoint-admin-center-office-365"></a>SharePoint 管理者センター (Office 365)
...
## <a name="site-collection-compliance-policies"></a>サイト コレクションのコンプライアンス ポリシー
...
## <a name="usage-reporting-and-logging"></a>使用状況のレポートとログ
