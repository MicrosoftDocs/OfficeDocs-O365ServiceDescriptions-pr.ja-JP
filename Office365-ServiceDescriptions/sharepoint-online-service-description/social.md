...
ブログにより、組織は従業員、パートナー、または顧客の間で情報をすばやく共有できます。 ユーザーはさまざまなサブジェクト領域への見識の追加、インスピレーションやガイダンスの提供、新しいガイダンスや手続きの説明ができます。
...
会社フィードは、組織のパブリックニュースフィードです。 ユーザーがフォローしていない人が作成した投稿も含めて、すべての投稿は会社に表示されます。 詳細については、「[会社フィード](https://support.office.com/article/D1A6A747-5789-498F-9DB5-C5692A9C9559)」を参照してください。
