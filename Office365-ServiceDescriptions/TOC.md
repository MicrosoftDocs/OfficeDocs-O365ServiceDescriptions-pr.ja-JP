...
## [サービスの説明の最近の変更](recent-service-descriptions-changes.md)
...
### [モバイル デバイス [SD]](office-365-platform-service-description/mobile-devices-sd.md)
...
### [メッセージングのポリシーと準拠 [ServiceDesc]](exchange-online-protection-service-description/messaging-policy-and-compliance-servicedesc.md)
### [スパム対策およびマルウェア対策保護 [EOP]](exchange-online-protection-service-description/anti-spam-and-anti-malware-protection-eop.md)
### [メール フロー [EOP]](exchange-online-protection-service-description/mail-flow-eop.md)
...
### [サイト [ServiceDesc]](sharepoint-online-service-description/sites-servicedesc.md)
