...
|**レポート**<sup>3</sup> ||||||
|Web データの *Project からのレポートの読み取* り | プロジェクト、プログラム、ポートフォリオ、およびリソース のデータを理解するために、一部の Power BI レポートまたはカスタム Power BI レポート、ダッシュボード、ポータルを表示します。 | いいえ | いいえ | はい | 必要 |
...
|**カスタマイズと統合**||||||
|アウトオブザボックスの Project アプリケーションを使用する | 既存の Project アプリケーションを使用して、プロジェクトの表示、新しいプロジェクトの作成、プロジェクトへの新しいデータの追加、または既存のプロジェクト データの更新を行います。 | 表示のみ | はい | はい | 必要 |
|ビューとフォームのカスタマイズ <sup>4</sup> | アウトオブザボックスの Project アプリケーションのビューとフォームのみをカスタマイズします。 | 表示のみ | はい | はい | 必要 |
|カスタム列の使用 | テーブルに追加された列のデータを表示、追加、更新、または削除します。 | 表示のみ | 表示のみ | はい | 必要 |
